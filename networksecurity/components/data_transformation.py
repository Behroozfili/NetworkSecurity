...
from networksecurity.utils.main_utils.utils import (save_object,save_numpy_array_data,read_data)
...
class DataTransformation:
  ...
  def get_data_transformer_object(cls)->Pipeline:
    """
    It initialises a KNNImputer object with the parameters speccified in the training_pipeline.py file 
    ...
    Returns:
        A pipeline object
    """
    logging.info("Entered get_data_transformer_object method transformation class ")
    try:
